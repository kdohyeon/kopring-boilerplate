package kdohyeon.boilerplate.entity.user;
...
public class UserHistoryEntity extends MutableBaseEntity {
    ...
    public UserHistoryEntity(
            String userId, String userRole, String clientIp, String reqMethod, String reqUrl, String reqHeader, String reqPayload
    ) {
        this.userId = userId;
